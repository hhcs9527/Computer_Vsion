...
def draw_camera(ax, R, pos, color):
    ...
    verts = [list(leftTriangle.reshape(3,3))]
    ax.add_collection3d(Poly3DCollection(verts, facecolors=color))
    
    verts = [list(topTriangle.reshape(3,3))]
    ax.add_collection3d(Poly3DCollection(verts, facecolors=color))
    
    verts = [list(rightTriangle.reshape(3,3))]
    ax.add_collection3d(Poly3DCollection(verts, facecolors=color))
    
    verts = [list(botTriangle.reshape(3,3))]
    ax.add_collection3d(Poly3DCollection(verts, facecolors=color))
